...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From yarn.lock, yarn@4.5.3
corepack enable

# step 2: dependencies, from your lockfile. From yarn.lock, yarn@4.5.3
